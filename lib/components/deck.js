...
var Deck = (_dec = (0, _reactRedux.connect)(function (state) {
  ...
  _createClass(Deck, [{
    ...
    value: function _handleEvent(e) {
      ...
      var prevSlide = this.props.prevSlide || this._prevSlide;
      var nextSlide = this.props.nextSlide || this._nextSlide;
    ...
    value: function _renderSlide() {
      var slide = this._getSlideIndex();
      var child = _react2.default.Children.toArray(this.props.children)[slide];
      return (0, _react.cloneElement)(child, {
        ...
        children: _react2.default.Children.toArray(child.props.children),
